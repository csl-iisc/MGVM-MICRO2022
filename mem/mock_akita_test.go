...
// Source: gitlab.com/akita/akita (interfaces: Port,Connection,Engine)
...
// AcceptHook mocks base method
func (m *MockConnection) AcceptHook(arg0 akita.Hook) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AcceptHook", arg0)
}
...
// NotifyAvailable mocks base method
func (m *MockConnection) NotifyAvailable(arg0 akita.VTimeInSec, arg1 akita.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) PlugIn(arg0 akita.Port, arg1 int) {
	m.ctrl.T.Helper()
...
// Send mocks base method
func (m *MockConnection) Send(arg0 akita.Msg) *akita.SendError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(*akita.SendError)
	return ret0
...
func (m *MockConnection) Unplug(arg0 akita.Port) {
	m.ctrl.T.Helper()
