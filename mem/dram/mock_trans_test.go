...
// Source: gitlab.com/akita/mem/dram/internal/trans (interfaces: SubTransactionQueue,SubTransSplitter)
...
func (m *MockSubTransactionQueue) Tick(arg0 akita.VTimeInSec) bool {
	m.ctrl.T.Helper()
