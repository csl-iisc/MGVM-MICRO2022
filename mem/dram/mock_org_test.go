...
func (m *MockChannel) GetReadyCommand(arg0 akita.VTimeInSec, arg1 *signal.Command) *signal.Command {
	m.ctrl.T.Helper()
...
func (m *MockChannel) StartCommand(arg0 akita.VTimeInSec, arg1 *signal.Command) {
	m.ctrl.T.Helper()
...
func (m *MockChannel) Tick(arg0 akita.VTimeInSec) bool {
	m.ctrl.T.Helper()
...
func (m *MockChannel) UpdateTiming(arg0 akita.VTimeInSec, arg1 *signal.Command) {
	m.ctrl.T.Helper()
