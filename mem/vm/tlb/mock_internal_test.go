...
// Source: gitlab.com/akita/mem/vm/tlb/internal (interfaces: Set)
...
func (m *MockSet) Lookup(arg0 ca.PID, arg1 uint64) (int, device.Page, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lookup", arg0, arg1)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(device.Page)
	ret2, _ := ret[2].(bool)
...
func (m *MockSet) Update(arg0 int, arg1 device.Page) {
	m.ctrl.T.Helper()
...
func (m *MockSet) Visit(arg0 int) int {
	m.ctrl.T.Helper()
