...
func (bms *deviceBuddyMemoryState) allocatePageTablePage(vAddr, pAddr uint64) uint64 {
	return bms.allocateMultiplePages(1)[0]
}

func (dms *deviceBuddyMemoryState) allocatePageOnChiplet(chiplet int) uint64 {
