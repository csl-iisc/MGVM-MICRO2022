...
type deviceLaspTppMemState struct {
...
func (dims *deviceLaspTppMemState) setInitialAddress(addr uint64) {
...
func newdeviceLaspTppMemState(log2pagesize uint64) DeviceMemoryState {
	return &deviceLaspTppMemState{
...
func (dims *deviceLaspTppMemState) getInitialAddress() uint64 {
	return dims.initialAddress
}

func (dims *deviceLaspTppMemState) setStorageSize(size uint64) {
	dims.storageSize = size
}

func (dims *deviceLaspTppMemState) getStorageSize() uint64 {
	return dims.storageSize
}

func (dims *deviceLaspTppMemState) addSinglePAddr(addr uint64) {
	panic("This should not be called!")
	// dims.availablePAddrs = append(dims.availablePAddrs, addr)
}

func (dims *deviceLaspTppMemState) popNextAvailablePAddrs() uint64 {
	// panic("This should not be called!")
...
func (dims *deviceLaspTppMemState) noAvailablePAddrs() bool {
	return len(dims.availablePAddrs) == 0
}

func (dims *deviceLaspTppMemState) allocateMultiplePages(
...
func (dims *deviceLaspTppMemState) allocatePageTablePage(
...
func (dims *deviceLaspTppMemState) allocatePageOnChiplet(
	chiplet int) uint64 {
	pAddr := dims.availablePAddrs[chiplet][0]
	dims.availablePAddrs[chiplet] = dims.availablePAddrs[chiplet][1:]
	return pAddr
