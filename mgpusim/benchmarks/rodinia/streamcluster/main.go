...
type KernelArgs struct {
	P                   driver.GPUPtr
	Coord               driver.GPUPtr
	WorkMem             driver.GPUPtr
	CenterTable         driver.GPUPtr
	SwitchMembership    driver.GPUPtr
	Num                 int32
	Dim                 int32
	X                   int64
	K                   int64
...
func (b *Benchmark) loadProgram() {
	...
	b.kernel = kernels.LoadProgramFromMemory(hsacoBytes, "pgain_kernel")
	if b.kernel == nil {
...
func (b *Benchmark) initMem() {
	...
	for i := uint64(0); i < b.ThreadBlockSize*b.NThreadBlocks; i++ {
		b.HostStarts[i] = HPCC_Starts(int64((b.NUpdates / b.NThreadBlocks / b.ThreadBlockSize) * i))
	}
