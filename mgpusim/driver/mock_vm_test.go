...
// Source: gitlab.com/akita/mem/device (interfaces: MemoryAllocator,PageTable)
...
// AllocatePageTablePage mocks base method
func (m *MockMemoryAllocator) AllocatePageTablePage(arg0 ca.PID, arg1 int) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllocatePageTablePage", arg0, arg1)
	ret0, _ := ret[0].(uint64)
	return ret0
}

// AllocatePageTablePage indicates an expected call of AllocatePageTablePage
func (mr *MockMemoryAllocatorMockRecorder) AllocatePageTablePage(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllocatePageTablePage", reflect.TypeOf((*MockMemoryAllocator)(nil).AllocatePageTablePage), arg0, arg1)
}

// AllocatePageWithGivenVAddr mocks base method
func (m *MockMemoryAllocator) AllocatePageWithGivenVAddr(arg0 ca.PID, arg1 int, arg2 uint64, arg3 bool) device.Page {
	m.ctrl.T.Helper()
...
func (m *MockMemoryAllocator) RegisterDevice(arg0 *device.Device) {
	m.ctrl.T.Helper()
