...
func (b H3PlatformBuilder) WithL2TLBStriping(striping uint64) H3PlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

func (b H3PlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *H3PlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeH3Builder()
