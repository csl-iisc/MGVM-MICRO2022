...
// H5PlatformBuilder can build a platform that equips DisTLBGPU GPU.
type H5PlatformBuilder struct {
	CommonPlatformBuilder
	l2TlbStriping uint64
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeH5PlatformBuilder() H5PlatformBuilder {
	b := H5PlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b H5PlatformBuilder) WithL2TLBStriping(striping uint64) H5PlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b H5PlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *H5PlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeH5Builder()
