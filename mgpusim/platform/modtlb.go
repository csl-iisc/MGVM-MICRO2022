...
// MODTLBGPUPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type MODTLBGPUPlatformBuilder struct {
...
func MakeMODTLBGPUPlatformBuilder() MODTLBGPUPlatformBuilder {
	b := MODTLBGPUPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b MODTLBGPUPlatformBuilder) WithL2TLBStriping(striping uint64) MODTLBGPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b MODTLBGPUPlatformBuilder) SwitchL2TLBStriping(switchStriping bool) MODTLBGPUPlatformBuilder {
	b.switchL2TLBStriping = switchStriping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b MODTLBGPUPlatformBuilder) UsePtCaching(ptCaching bool) MODTLBGPUPlatformBuilder {
	b.usePtCaching = ptCaching
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b MODTLBGPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *MODTLBGPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeMODTLBGPUBuilder()
