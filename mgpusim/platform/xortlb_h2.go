...
// XORTLBH2GPUPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type XORTLBH2GPUPlatformBuilder struct {
	CommonPlatformBuilder
	l2TlbStriping uint64
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeXORTLBH2GPUPlatformBuilder() XORTLBH2GPUPlatformBuilder {
	b := XORTLBH2GPUPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b XORTLBH2GPUPlatformBuilder) WithL2TLBStriping(striping uint64) XORTLBH2GPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b XORTLBH2GPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *XORTLBH2GPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeXORTLBH2GPUBuilder()
