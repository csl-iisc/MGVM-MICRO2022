...
type DistributedTLBGPUPlatformBuilder struct {
	CommonPlatformBuilder
	l2TlbStriping uint64
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeDistributedTLBGPUPlatformBuilder() DistributedTLBGPUPlatformBuilder {
	b := DistributedTLBGPUPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b DistributedTLBGPUPlatformBuilder) WithL2TLBStriping(striping uint64) DistributedTLBGPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b DistributedTLBGPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *DistributedTLBGPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeDistributedTLBGPUBuilder()
