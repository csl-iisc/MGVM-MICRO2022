...
import (
	...
	"gitlab.com/akita/mgpusim/builders/distlbgpubuilder"
	"gitlab.com/akita/mgpusim/driver"
	"gitlab.com/akita/noc/networking/pcie"
	"gitlab.com/akita/util/tracing"
)

// DisTLBGPUPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type DisTLBGPUPlatformBuilder struct {
...
// MakeDisTLBGPUBuilder creates a EmuBuilder with default parameters.
func MakeDisTLBGPUBuilder() DisTLBGPUPlatformBuilder {
	b := DisTLBGPUPlatformBuilder{
		numGPU:                   1,
...
func (b DisTLBGPUPlatformBuilder) WithParallelEngine() DisTLBGPUPlatformBuilder {
	b.useParallelEngine = true
	return b
}

// WithISADebugging enables ISA debugging in the simulation.
func (b DisTLBGPUPlatformBuilder) WithISADebugging() DisTLBGPUPlatformBuilder {
	b.debugISA = true
	return b
}

// WithVisTracing lets the platform to record traces for visualization purposes.
func (b DisTLBGPUPlatformBuilder) WithVisTracing() DisTLBGPUPlatformBuilder {
	b.traceVis = true
	return b
}

// WithTLBTracing lets the platform to trace memory operations.
func (b DisTLBGPUPlatformBuilder) WithTLBTracing() DisTLBGPUPlatformBuilder {
	b.traceTLB = true
	return b
}

// WithMemTracing lets the platform to trace memory operations.
func (b DisTLBGPUPlatformBuilder) WithMemTracing() DisTLBGPUPlatformBuilder {
	b.traceMem = true
	return b
}

// WithNumGPU sets the number of GPUs to build.
func (b DisTLBGPUPlatformBuilder) WithNumGPU(n int) DisTLBGPUPlatformBuilder {
	b.numGPU = n
	return b
}

// WithoutProgressBar disables the progress bar for kernel execution
func (b DisTLBGPUPlatformBuilder) WithoutProgressBar() DisTLBGPUPlatformBuilder {
	b.disableProgressBar = true
	return b
}

// WithLog2PageSize sets the page size as a power of 2.
func (b DisTLBGPUPlatformBuilder) WithLog2PageSize(
	n uint64,
) DisTLBGPUPlatformBuilder {
	b.log2PageSize = n
	return b
}

// WithLog2PageSize sets the page size as a power of 2.
func (b DisTLBGPUPlatformBuilder) WithMemAllocatorType(memAllocatorType string) DisTLBGPUPlatformBuilder {
	b.memAllocatorType = memAllocatorType
	return b
}

func (b DisTLBGPUPlatformBuilder) WithAlg(alg string) DisTLBGPUPlatformBuilder {
	b.alg = alg
	return b
}

func (b DisTLBGPUPlatformBuilder) UseCoalescingTLBPort(u bool) DisTLBGPUPlatformBuilder {
	b.useCoalescingTLBPort = u
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b DisTLBGPUPlatformBuilder) WithL2TLBStriping(striping uint64) DisTLBGPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// // WithNumChiplets sets the number of chiplets in the mcm GPU.
// func (b DisTLBGPUPlatformBuilder) WithNumChiplets(n uint64) DisTLBGPUPlatformBuilder {
// 	b.numChiplets = n
// 	return b
// }

// Build builds a platform with DisTLBGPU GPUs.
func (b DisTLBGPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b DisTLBGPUPlatformBuilder) createGPUs(
	rootComplexID int,
	pcieConnector *pcie.Connector,
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
...
func (b DisTLBGPUPlatformBuilder) createPMCPageTable() *cache.BankedLowModuleFinder {
...
func (b DisTLBGPUPlatformBuilder) createRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b DisTLBGPUPlatformBuilder) createConnection(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) (*pcie.Connector, int) {
...
func (b DisTLBGPUPlatformBuilder) createEngine() akita.Engine {
...
// func (b DisTLBGPUPlatformBuilder) createMMU(
// 	engine akita.Engine,
...
func (b *DisTLBGPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) distlbgpubuilder.DisTLBGPUBuilder {
	gpuBuilder := distlbgpubuilder.MakeDisTLBGPUBuilder().
		WithEngine(engine).
	...
	gpuBuilder = b.setUseCoalescingTLBPort(gpuBuilder)
...
func (b *DisTLBGPUPlatformBuilder) setISADebugger(
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
) distlbgpubuilder.DisTLBGPUBuilder {
	if !b.debugISA {
		return gpuBuilder
...
func (b *DisTLBGPUPlatformBuilder) setUseCoalescingTLBPort(
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
) distlbgpubuilder.DisTLBGPUBuilder {
	if b.useCoalescingTLBPort {
		gpuBuilder = gpuBuilder.UseCoalescingTLBPort()
	}
	return gpuBuilder
}

func (b *DisTLBGPUPlatformBuilder) setTLBTracer(
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
) distlbgpubuilder.DisTLBGPUBuilder {
	if !b.traceTLB {
		return gpuBuilder
...
func (b *DisTLBGPUPlatformBuilder) setMemTracer(
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
) distlbgpubuilder.DisTLBGPUBuilder {
	if !b.traceMem {
		return gpuBuilder
...
func (b *DisTLBGPUPlatformBuilder) setVisTracer(
	gpuDriver *driver.Driver,
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
) distlbgpubuilder.DisTLBGPUBuilder {
	if !b.traceVis {
...
func (b *DisTLBGPUPlatformBuilder) createGPU(
	index int,
	gpuBuilder distlbgpubuilder.DisTLBGPUBuilder,
	gpuDriver *driver.Driver,
	rdmaAddressTable *cache.BankedLowModuleFinder,
...
// func (b *DisTLBGPUPlatformBuilder) configRDMAEngine(
// 	gpu *mgpusim.GPU,
...
func (b *DisTLBGPUPlatformBuilder) configPMC(
	gpu *mgpusim.GPU,
	gpuDriver *driver.Driver,
	addrTable *cache.BankedLowModuleFinder,
) {
