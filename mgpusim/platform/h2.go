...
func (b H2PlatformBuilder) WithL2TLBStriping(striping uint64) H2PlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

func (b H2PlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *H2PlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeH2Builder()
