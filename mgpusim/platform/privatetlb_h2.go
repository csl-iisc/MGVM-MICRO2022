...
type PrivateH2TLBPlatformBuilder struct {
	CommonPlatformBuilder
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakePrivateH2TLBPlatformBuilder() PrivateH2TLBPlatformBuilder {
	b := PrivateH2TLBPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b PrivateH2TLBPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *PrivateH2TLBPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakePrivateH2TLBGPUBuilder()
