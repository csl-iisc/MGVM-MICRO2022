...
// H7GPUPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type H7GPUPlatformBuilder struct {
	CommonPlatformBuilder
	l2TlbStriping uint64
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeH7GPUPlatformBuilder() H7GPUPlatformBuilder {
	b := H7GPUPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b H7GPUPlatformBuilder) WithL2TLBStriping(striping uint64) H7GPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b H7GPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *H7GPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeH7GPUBuilder()
