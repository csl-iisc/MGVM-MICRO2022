...
// OldIdealVM2GPUBuilder can build MCM GPUs.
type OldIdealVM2GPUBuilder struct {
	engine                         akita.Engine
	freq                           akita.Freq
...
// MakeOldIdealVM2GPUBuilder provides a GPU builder that can builds the MCM GPU.
func MakeOldIdealVM2GPUBuilder() OldIdealVM2GPUBuilder {
	b := OldIdealVM2GPUBuilder{
		freq:                           1 * akita.GHz,
...
func (b OldIdealVM2GPUBuilder) WithEngine(engine akita.Engine) OldIdealVM2GPUBuilder {
	b.engine = engine
	return b
}

// WithFreq sets the frequency that the GPU works at.
func (b OldIdealVM2GPUBuilder) WithFreq(freq akita.Freq) OldIdealVM2GPUBuilder {
	b.freq = freq
	return b
}

// WithMemAddrOffset sets the address of the first byte of the GPU to build.
func (b OldIdealVM2GPUBuilder) WithMemAddrOffset(
	offset uint64,
) OldIdealVM2GPUBuilder {
	b.memAddrOffset = offset
	return b
}

// WithTotalMem sets the total amount of memory in the GPU.
func (b OldIdealVM2GPUBuilder) WithTotalMem(memory uint64) OldIdealVM2GPUBuilder {
	b.totalMem = memory
	return b
}
...
func (b OldIdealVM2GPUBuilder) WithNumMemoryBankPerChiplet(n int) OldIdealVM2GPUBuilder {
	b.numMemoryBankPerChiplet = n
	return b
}

// WithNumChiplet sets the number of chiplets
func (b OldIdealVM2GPUBuilder) WithNumChiplet(n int) OldIdealVM2GPUBuilder {
	b.numChiplet = n
	return b
}

// WithNumShaderArrayPerChiplet sets the number of shader arrays in each chiplet
func (b OldIdealVM2GPUBuilder) WithNumShaderArrayPerChiplet(n int) OldIdealVM2GPUBuilder {
...
// each Shader Array.
func (b OldIdealVM2GPUBuilder) WithNumCUPerShaderArray(n int) OldIdealVM2GPUBuilder {
...
func (b OldIdealVM2GPUBuilder) WithLog2MemoryBankInterleavingSize(
	n uint64,
) OldIdealVM2GPUBuilder {
...
// components
func (b OldIdealVM2GPUBuilder) WithVisTracer(t tracing.Tracer) OldIdealVM2GPUBuilder {
...
func (b OldIdealVM2GPUBuilder) WithMemTracer(t tracing.Tracer) OldIdealVM2GPUBuilder {
...
func (b OldIdealVM2GPUBuilder) WithISADebugging() OldIdealVM2GPUBuilder {
	b.enableISADebugging = true
	return b
}

// WithoutProgressBar disables the progress bar for kernel execution
func (b OldIdealVM2GPUBuilder) WithoutProgressBar() OldIdealVM2GPUBuilder {
	b.disableProgressBar = true
	return b
}

// WithLog2CacheLineSize sets the cache line size with the power of 2.
func (b OldIdealVM2GPUBuilder) WithLog2CacheLineSize(
...
func (b OldIdealVM2GPUBuilder) WithLog2PageSize(log2PageSize uint64) OldIdealVM2GPUBuilder {
	b.log2PageSize = log2PageSize
	return b
}

// WithPageTable sets the page size with the power of 2.
func (b OldIdealVM2GPUBuilder) WithPageTable(pt *device.PageTableImpl) OldIdealVM2GPUBuilder {
	b.pageTable = pt
	return b
}

// WithoutProgressBar disables the progress bar for kernel execution
func (b OldIdealVM2GPUBuilder) WithAlg(alg string) OldIdealVM2GPUBuilder {
	b.alg = alg
	return b
}
...
func (b OldIdealVM2GPUBuilder) CalculateMemoryParameters() OldIdealVM2GPUBuilder {
...
func (b OldIdealVM2GPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *OldIdealVM2GPUBuilder) createGPU(name string, id uint64) {
	b.gpuName = name
...
func (b *OldIdealVM2GPUBuilder) buildCP() {
...
func (b *OldIdealVM2GPUBuilder) buildDMAEngine() {
...
func (b *OldIdealVM2GPUBuilder) BuildSAs(chiplet *Chiplet) {
...
func (b *OldIdealVM2GPUBuilder) buildSA(
...
func (b *OldIdealVM2GPUBuilder) buildMemBanks(chiplet *Chiplet) {
...
// func (b *OldIdealVM2GPUBuilder) createDRAMControllerBuilder() dram.Builder {
// 	memBankSize := 4 * mem.GB / uint64(b.numMemoryBankPerChiplet)
// 	if 4*mem.GB%uint64(b.numMemoryBankPerChiplet) != 0 {
...
func (b *OldIdealVM2GPUBuilder) configChipRDMAEngine(
	chiplet *Chiplet,
...
// func (b *OldIdealVM2GPUBuilder) configRemoteAddressTranslationUnit(
// 	chiplet *Chiplet,
...
func (b *OldIdealVM2GPUBuilder) connectCP() {
...
func (b *OldIdealVM2GPUBuilder) connectCPWithCUs() {
...
func (b *OldIdealVM2GPUBuilder) connectCPWithAddressTranslators() {
	for _, chiplet := range b.chiplets {
...
func (b *OldIdealVM2GPUBuilder) connectCPWithCaches() {
	for _, chiplet := range b.chiplets {
...
func (b *OldIdealVM2GPUBuilder) connectL1ToL2(chiplet *Chiplet) {
...
func (b *OldIdealVM2GPUBuilder) connectL2ToDRAM(chiplet *Chiplet) {
...
func (b *OldIdealVM2GPUBuilder) buildPageMigrationController() {
...
func (b *OldIdealVM2GPUBuilder) setupDMA() {
...
func (b *OldIdealVM2GPUBuilder) setupInterchipNetwork() {
...
func (b *OldIdealVM2GPUBuilder) buildRDMAEngine() {
...
func (b *OldIdealVM2GPUBuilder) createChipRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b *OldIdealVM2GPUBuilder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {
	return nil
}
